...
<form action="#" on:submit={submitForm}>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <input autocomplete="" type="text" id="matching_pattern" bind:value={tag_rule.matching_pattern} on:change={onFormChange} class="form-control">
        </div>
    </div>
    ...
    <div class="row">
        <div class="offset-sm-2 col-sm-10">
            <div class="form-check">
                <input class="form-check-input" type="checkbox" id="is_regex" bind:checked={tag_rule.is_regex} on:change={onFormChange}>
