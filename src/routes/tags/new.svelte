...
<form action="#" on:submit={submitForm}>
    ...
    <div class="row">
        <label for="tag_name" class="col-form-label col-sm-2">
            Name
        </label>
        <div class="col-sm-10">
            <input autocomplete="" type="text" id="tag_name" bind:value={tag.name} on:change={onFormChange} class="form-control">
        </div>
    </div>
