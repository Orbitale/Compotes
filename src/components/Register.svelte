<script lang="ts">
    import message from "../utils/Toast.ts";
...
<form id="register" on:submit={onFormSubmit} method="post" action="#">
    ...
    <label for="register_password_repeat" class="form-label">Repeat password</label>
